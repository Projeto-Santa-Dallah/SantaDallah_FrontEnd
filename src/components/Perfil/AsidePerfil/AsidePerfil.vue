...
import userIcon from '@/components/iconsPerfil/userIcon.vue';
import markerPinIcon from '@/components/iconsPerfil/markerPinIcon.vue';
import packageIcon from '@/components/iconsPerfil/packageIcon.vue';
import walletIcon from '@/components/iconsPerfil/walletIcon.vue';
...
<template>
  <div class="span-nav">
    ...
    <div class="links" v-if="useTemplate.isAdmin">
      <ul>
