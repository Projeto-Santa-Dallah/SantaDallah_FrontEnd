  ...
  <div class="tudo">
    <div class="info-principal">
      <div class="nome-container">
        ...
        <span class="info"> Fatias: {{ qtdFatia }}</span>
        <span class="info">{{ massakg }}</span>
        <span class="info"> Formato: {{ formato }}</span>
    ...
    <div class="informacoes">
      <svg   @click.stop="$emit('editar', id)"  class="svg" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <svg  class="svg" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" @click="useTamanho.excluirTamanho(props.id)">
          <path
