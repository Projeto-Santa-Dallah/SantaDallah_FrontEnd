...
<template>
    <div class="tudo" >
        ...
        <div class="informacoes">
            ...
            <svg  class="svg" width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg" @click="produtosStore.excluirProduto(props.id)">
                <path
